...
//   const onStartPlay1 = async (uri) => {
//     playAudio(uri, `audio-${message.id}`);
//   };
...
//   const isPlaying =
//     presentAudio.id && presentAudio.id === `audio-${message.id}`;
...
//               <Icon
//                 onPress={() => {
//                   if (isPlaying && presentAudio.playing) {
//                     onPause();
//                   } else if (isPlaying && !presentAudio.playing) {
//                     onResume();
//                   } else {
//                     onPlay(message.fattach.attach, message.id);
//                   }
//                 }}
//                 name={isPlaying && presentAudio.playing ? 'pause' : 'play'}
//                 style={{color: 'grey'}}
//               />
//               <View
//                 style={{
...
//                   value={
//                     isPlaying
//                       ? presentAudio.duration === 0
//                         ? 0
//                         : presentAudio.current / presentAudio.duration
//                       : 0
//                   }
//                   thumbStyle={{width: 10, height: 10}}
//                 />
