  ...
  renderInnerImageList(item, index, separators) {
    return (
      <TouchableOpacity activeOpacity={1} style={{ flex: 1 }}>
        ...
        {/* <Image style={styles.imageView} source={require('../images/productImage5.png')} /> */}
      ...
      <SafeAreaView style={styles.mainContainer}>
        ...
        showsVerticalScrollIndicator={false}>
          ...
          />
            ...
            <Text style={styles.DescriptionStyle2}>Finish off your wardrobe with this high-end top from Harpa. This piece will look fabulously styled with a slim jean for a casual Friday in the office.</Text>
