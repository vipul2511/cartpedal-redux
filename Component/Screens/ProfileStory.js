        ...
        return (
          ...
          <View style={{flexDirection:'row'}}>
            ...
            <View style={styles.CloseButtonContainerStyles}>
              <Image style={styles.CloseButtonViewStyles} source={this.state.avatar==''?(this.state.defaultavatar):{uri:this.state.avatar}} />
            </View>
            <View>
                <View style={{width:300}}>
              <Text style={styles.username}>{this.state.nameStory}</Text>
              </View>
        <Text style={{marginLeft:8,marginTop:5,fontSize:12}}>{this.state.currentTime}</Text>
            </View>
            </View>
