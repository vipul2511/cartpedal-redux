          ...
          fetch(RemoveCartListURL, {
            ...
            this.hideLoading();
              ...
              //  this.props.navigation.navigate('StoryViewScreen')
               ...
               let filterData=item.filter(items=>items.id!==this.state.productID);
        ...
        />
                    ...
                    <ScrollView>
                        ...
                        <View style={styles.Profile2Container}>
                            ...
                            <View style={styles.Profile2InfoContainer}>
                                <Text style={styles.PersonNameStyle}>{this.state.nameOfuser}</Text>
                                <View style={{width:width*0.7}} >
                                {this.state.about? (
                        <Text style={{fontSize:resp(13),color:'gray'}}>{this.state.about}</Text>
                ):null}
                  </View>                        
                               </View>
            ...
            this.props.navigation.navigate('ChatDetailScreen',{userid:this.state.block_id, username:this.state.nameOfuser,useravatar:this.state.avatar, groupexit:false,groupId:0})
              ...
              <Image
                ...
                style={[styles.heartButtonStyle,{width:this.state.favourite==1?resp(9):resp(18),height:this.state.favourite==1?resp(7):resp(18),marginTop:this.state.favourite==1?resp(3):resp(0)}]}></Image>
            </TouchableOpacity>
