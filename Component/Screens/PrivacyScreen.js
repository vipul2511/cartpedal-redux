                    ...
                    <ScrollView>
                        ...
                        <TouchableOpacity style={styles.Profile2Container}>
                            ...
                            <View style={styles.Profile2InfoContainer}>
                                <Text style={styles.PersonNameStyle}>Who can see my personal info</Text>
                        ...
                        <ToggleSwitch
                            label="Read Receipts"
                            labelStyle={{marginTop:resp(20), width: resp(320), color: '#000000E6', fontSize: resp(16), fontWeight: 'bold', marginLeft: resp(20) }}
                        ...
                        if turned off, you won't send or receive Read receipts, Read receive are always sent for group chat
                                  </Text>
                    </ScrollView>
                </View>
